...
const SearchSvg = `<svg viewBox="64 64 600 600" style="margin-top: 8px" focusable="false" data-icon="search" width="1.2em" height="1.2em" fill="currentColor" aria-hidden="true">
...
const ControlsClass = L.Control.Zoom.extend( {
    onAdd: function ( map: L.Map ) {
        ...
        this._searchButton = this._createButton( SearchSvg, 'Search', 'leaflet-control-follow', container, this._openSearch );
