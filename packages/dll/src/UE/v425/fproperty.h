...
{
	// Offsets are probably wrong
	int32_t	ArrayDim; //0x38 0x30
	...
	FProperty* NextRef; // 0x68  0x60
	FProperty* DestructorLinkNext; // 0x70  0x68
	FProperty* PostConstructLinkNext; // 0x78   0x70
};
