import { IDelegateProperty, PropertyType } from "@rrox/api";
...
export class DelegateProperty extends BasicProperty<PropertyType.DelegateProperty> implements IDelegateProperty {
    private readonly functionName: string;

    constructor( app: RROxApp, config: IPropertyConfig<PropertyType.DelegateProperty>, functionName: string = '' ) {
        super( app, config );
