...
export const PluginsCommunicator = SharedCommunicator<ValueCommunicator<[ installed: { [ name: string ]: IPlugin }, loaded: string[], installed: boolean ]>>( PluginInfo, 'plugins' );
